...
use {
    crate::types::GameMode,
    carbon_core::{account_utils::next_account, deserialize::ArrangeAccounts},
    solana_pubkey::Pubkey,
};
/// Creates a new spl-22 coin and bonding curve, with an explicit game mode
/// for mayhem coins.
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CreateV3InstructionAccounts {
...
impl CreateV3 {
    pub fn decode(data: &[u8]) -> Option<Self> {
        ...
        if discriminator != [187, 141, 50, 115, 53, 212, 36, 40] {
            return None;
        }
...
impl ArrangeAccounts for CreateV3 {
    type ArrangedAccounts = CreateV3InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(CreateV3InstructionAccounts {
            mint,
            mint_authority,
            bonding_curve,
