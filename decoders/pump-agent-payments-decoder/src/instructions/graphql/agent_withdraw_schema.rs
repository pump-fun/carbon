...
#[graphql(name = "AgentWithdraw")]
pub struct AgentWithdrawGraphQL {
...
impl TryFrom<crate::instructions::postgres::AgentWithdrawRow> for AgentWithdrawGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::AgentWithdrawRow) -> Result<Self, Self::Error> {
        Ok(Self {
