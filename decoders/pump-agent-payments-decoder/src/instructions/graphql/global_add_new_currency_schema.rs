...
#[graphql(name = "GlobalAddNewCurrency")]
pub struct GlobalAddNewCurrencyGraphQL {
...
impl TryFrom<crate::instructions::postgres::GlobalAddNewCurrencyRow>
    for GlobalAddNewCurrencyGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::GlobalAddNewCurrencyRow,
