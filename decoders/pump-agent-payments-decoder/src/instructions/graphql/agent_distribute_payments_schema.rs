...
#[graphql(name = "AgentDistributePayments")]
pub struct AgentDistributePaymentsGraphQL {
...
impl TryFrom<crate::instructions::postgres::AgentDistributePaymentsRow>
    for AgentDistributePaymentsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AgentDistributePaymentsRow,
