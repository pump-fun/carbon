...
pub mod boost_buy_and_burn_row;
...
pub use self::{
    admin_set_coin_creator_row::*, admin_update_token_incentives_row::*, boost_buy_and_burn_row::*,
    buy_exact_quote_in_row::*, buy_row::*, claim_cashback_row::*, claim_token_incentives_row::*,
    ...
    extend_account_row::*, init_boost_row::*, init_user_volume_accumulator_row::*,
    migrate_pool_coin_creator_row::*, sell_row::*, set_boost_authority_row::*,
    set_coin_creator_row::*, set_reserved_fee_recipients_row::*,
    sync_user_volume_accumulator_row::*, toggle_boost_row::*, toggle_cashback_enabled_row::*,
    toggle_mayhem_mode_row::*, transfer_creator_fees_to_pump_row::*,
    transfer_creator_fees_to_pump_v2_row::*, update_admin_row::*, update_buyback_config_row::*,
...
impl sqlx_migrator::Migration<sqlx::Postgres> for PumpAmmInstructionsMigration {
    ...
    fn operations(&self) -> Vec<Box<dyn sqlx_migrator::Operation<sqlx::Postgres>>> {
        vec![
            ...
            Box::new(BoostBuyAndBurnMigrationOperation),
            ...
            Box::new(InitBoostMigrationOperation),
            ...
            Box::new(SetBoostAuthorityMigrationOperation),
            ...
            Box::new(ToggleBoostMigrationOperation),
...
impl carbon_core::postgres::operations::Insert for PumpAmmInstructionWithMetadata {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        match instruction {
            ...
            PumpAmmInstruction::BoostBuyAndBurn(instruction) => {
                let row = boost_buy_and_burn_row::BoostBuyAndBurnRow::from_parts(
                    instruction.clone(),
                    metadata.clone(),
                    accounts.clone(),
                );
            ...
            PumpAmmInstruction::InitBoost(instruction) => {
                let row = init_boost_row::InitBoostRow::from_parts(
                    instruction.clone(),
                    metadata.clone(),
                    accounts.clone(),
                );
            ...
            PumpAmmInstruction::SetBoostAuthority(instruction) => {
                let row = set_boost_authority_row::SetBoostAuthorityRow::from_parts(
                    instruction.clone(),
                    metadata.clone(),
                    accounts.clone(),
                );
            ...
            PumpAmmInstruction::ToggleBoost(instruction) => {
                let row = toggle_boost_row::ToggleBoostRow::from_parts(
                    instruction.clone(),
                    metadata.clone(),
                    accounts.clone(),
                );
