...
#[graphql(name = "ToggleBoost")]
pub struct ToggleBoostGraphQL {
...
impl TryFrom<crate::instructions::postgres::ToggleBoostRow> for ToggleBoostGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ToggleBoostRow) -> Result<Self, Self::Error> {
        Ok(Self {
