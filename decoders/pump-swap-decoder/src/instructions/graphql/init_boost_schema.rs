...
#[graphql(name = "InitBoost")]
pub struct InitBoostGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitBoostRow> for InitBoostGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::InitBoostRow) -> Result<Self, Self::Error> {
        Ok(Self {
