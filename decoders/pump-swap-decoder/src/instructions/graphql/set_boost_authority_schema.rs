...
#[graphql(name = "SetBoostAuthority")]
pub struct SetBoostAuthorityGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetBoostAuthorityRow> for SetBoostAuthorityGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetBoostAuthorityRow,
